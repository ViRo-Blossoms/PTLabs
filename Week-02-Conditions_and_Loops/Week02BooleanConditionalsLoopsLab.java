...
public class Week02BooleanConditionalsLoopsLab {
	...
	public static void main(String[] args) {
		...
		//
			...
			int numberOfChildren = 9;
			int numberOfCookies = 17;
			
			for (int remainder = 0; numberOfCookies >= numberOfChildren;)
			{
			numberOfCookies = numberOfCookies - numberOfChildren;
			}
			...
			double billTotal = 692.20;
			double adjustedTotal = 0;
			
			adjustedTotal = billTotal - (billTotal * loyaltyMemberDiscount);
			System.out.println("Your total after savings is: " + adjustedTotal);
			
			if (adjustedTotal >= 500 && loyaltyMemberStatus == "SILVER")
			{
				loyaltyMemberStatus = "GOLD";
				System.out.println("UPGRADE: " + loyaltyMemberStatus + " " + loyaltyMemberDiscount);
			}
			else if (adjustedTotal >= 500 && loyaltyMemberStatus == "Gold")
			{
				...
				String username = "JoJohnson";
				String password = "12345";
				if (username == "Tommy125" && password == "12345")
				{
